...
create policy school_delete_comment_vote on aula.comment_vote for delete using (aula.is_admin(school_id) or (aula.is_owner(school_id))) with check (aula.is_admin(school_id));
